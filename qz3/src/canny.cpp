//File from opencv source 
//Modified with self-adaptive threshold value
//Refer:blog.chinaunix
...
extern "C"
CV_IMPL void cvCannyA( const void* srcarr, void* dstarr,
